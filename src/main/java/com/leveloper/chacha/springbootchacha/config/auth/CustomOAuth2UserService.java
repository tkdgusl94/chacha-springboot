...
import com.leveloper.chacha.springbootchacha.config.auth.dto.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException{
         ...
         * 네이버까지 로그인 연동 시에 네이버 로그인인지, 구글 로그인인지 구분하기 위해 사용한다.
         */
         ...
         */
        String userNameAttributeName = userRequest // 네이버 로그인과 구글 로그인을 동시 지원할 때 사용함.
